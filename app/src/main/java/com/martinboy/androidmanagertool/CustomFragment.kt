...
class CustomFragment : BaseViewUtilsFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnGo!!.setOnClickListener {
            if (this@CustomFragment.activity != null) {
                val mAct = this@CustomFragment.activity as CustomFragmentActivity?
                //                    mAct.switchFragment(SecondFragment.class, null, true);
                mAct?.transFragment(CustomFragment2::class.java, null, true, false)
            }
        }
    ...
    private fun startThread() {
        ...
        val customRunnable = Thread(CustomRunnable(object : CustomRunnable.CallBack {
            override fun returnValue(word: String?) {
                if (this@CustomFragment.activity == null) return
                this@CustomFragment.activity?.runOnUiThread { text1!!.text = word }
            }
        }))
